...
<html:form method="POST" action="/Cwt">
    <h2>
        Course Work Therapy - Competency/Skill Set Search Results
    </h2>
               ...
               <logic:iterate id="loop" name="cwtForm" property="metricList">
                <tr>
                    <td class="searchRowOdd2">
                    	 <a href="<%=request.getContextPath()%>/Cwt.do?action=Edit&type=Metric&id=<bean:write name="loop" property="metricId"/>" >
