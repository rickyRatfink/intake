...
<tr>
	<td align="center" colspan="13">
		<h2>Boynton Beach Job List&nbsp;<i><%=df.format(ddate) %></i></h3>
	</td>
</tr>

<tr>
	<th width="14%" class="header" >MILES MARSHALL<br/>RODNEY PACK</th>
	<th width="5" bgcolor="#000000"></th>
    <th width="14%" class="header">TROY HARDY</th> 
    <th width="5" bgcolor="#000000"></th>
    <th width="14%" class="header">MILES MARSHALL</th>
    <th width="5" bgcolor="#000000"></th>
    <th width="14%" class="header">MILES MARSHALL</br>NIMAI MEDEROS</th>
    <th width="5" bgcolor="#000000"></th>
    <th width="14%" class="header">MILES MARSHALL</br>NIMAI MEDEROS</th>
    <th width="5" bgcolor="#000000"></th>
    <th width="14%" class="header">TROY HARDY</br>JAMES RITCHEY</th>
    <th width="5" bgcolor="#000000"></th>
    <th width="14%" class="header">TROY HARDY</br>CAMERON PEACHER</br>FRED RODRIGUEZ</th>
</tr>
<tr>
	<td valign="top">
