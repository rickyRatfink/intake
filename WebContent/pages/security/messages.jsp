...
<logic:equal name="loginForm" property="messageType" value="error">
...
<logic:equal name="loginForm"  property="messageType" value="info">
...
<logic:equal name="loginForm"  property="messageType" value="success">
		<table width="434" cellpadding="0" cellspacing="0" border="0">
		<tr>
...
<logic:equal name="loginForm" property="messageType" value="warning">
		<table width="434" cellpadding="0" cellspacing="0" border="0">
		<tr>
